...
const challenges = [
  ...
  { name: "Capital Club Champions League", logo: "images/capitalclub.png", description: "Manage a club from a capital city that has never won the Champions League and lead them to European glory.", tasks: ["Choose a club from a capital city that has never won the Champions League","Win the Champions League with that club"], duration: 4, difficulty: 5 },
