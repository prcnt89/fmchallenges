...
const challenges = [
  ...
  { name: "Siblings (FM 26)", logo: "images/siblings.png", description: "Manage a club with both a women’s and men’s team and lead both squads to domestic glory.", tasks: ["Manage the club’s women’s team","Win the top division in women’s football","Manage the same club’s men’s team","Win the top division in men’s football"], duration: 5, difficulty: 3 },
  { name: "Giant Squad", logo: "images/giantsquad.png", description: "Build a physically dominant team composed entirely of tall players.", tasks: ["Sign only players who are at least 190 cm tall","Create a tactic that focuses on aerial strength","Win your domestic league with your tall-only squad"], duration: 3, difficulty: 3 },
  { name: "Mini Maestro XI", logo: "images/minimaestro.png", description: "Assemble a technically gifted team made up of small, agile players.", tasks: ["Sign only players who are 175 cm or shorter","Build a possession-heavy, technical tactic","Win your domestic league with your tall-only squad"], duration: 3, difficulty: 3 },
{ name: "Rollercoaster", logo: "images/rollercoaster.png", description: "Begin your career at the top with maximum reputation and licenses, but if you fail, restart at the bottom and fight your way back to manage your favourite club again.", tasks: ["Create a manager with the highest license and top reputation","Manage your favourite club until retirement","If you get sacked, create a new manager with the lowest qualifications","Start unemployed and work your way back to your favourite club"], duration: 5, difficulty: 3 }
];
